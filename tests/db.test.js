...
test('collectionSeries: comic + manga rows keep their exact field shape (no ebook fields leak in)', async () => {
  ...
  assert.equal(keyset, ['active', 'available', 'corrupt', 'cover_url', 'cv_id', 'cv_locked', 'files', 'folder', 'followed', 'id', 'latest', 'matched', 'missing', 'monitor', 'monitor_from', 'monitored', 'on_demand', 'owned', 'pub_status', 'publisher', 'restricted', 'size', 'source', 'sourced', 'title', 'total', 'type', 'untagged', 'year'].join(','));
});
